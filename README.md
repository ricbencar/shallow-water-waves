...
The **Diagnostic Ratios** section features ratios like $H\_{1/3}/H\_{m0}$ which are used to compare the model output against theoretical Rayleigh values. A ratio of $(H\_{1/3}/H\_{m0}$ less than 1 signifies the effect of depth-induced breaking, whilke the opposite indicates the influence of the broad-band spectrum correction.
