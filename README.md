...
$$\tilde{H}_{tr} = \frac{H_{tr\_dim}}{H_{rms}}$$A critical adjustment is applied: if $$\tilde{H}_{tr}$$ exceeds 3.5, it is capped at 3.5, and $$H_{tr\_dim}$$ is recalculated to maintain consistency, as the model's empirical basis is limited beyond this value:
