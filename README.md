...
$$
\begin{aligned}
\tilde{H}_{1/N} ={}& N \cdot H_1 \Bigl[ \Gamma\left(\frac{1}{k_1}+1, \ln(N)\right)
&- \Gamma\left(\frac{1}{k_1}+1, \left(\frac{H_{tr}}{H_1}\right)^{k_1}\right) \Bigr] \\
&+ N \cdot H_2 \cdot \Gamma\left(\frac{1}{k_2}+1, \left(\frac{H_{tr}}{H_2}\right)^{k_2}\right)
\end{aligned}
$$
