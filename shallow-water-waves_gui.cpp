 ...
 * native Win32 API and standard C++. It allows the user to input three
 * key parameters:
 *
 ...
 * distribution. This involves a Newton-Raphson matrix method.
 *
 * - A detailed report is generated and displayed, and also saved to "report.txt".
 *
